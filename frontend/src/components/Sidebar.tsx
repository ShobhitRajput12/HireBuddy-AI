...
import {
  ...
  Bell, ChevronRight, PieChart, X, CheckCircle2, Upload, AlertCircle, Info,
} from 'lucide-react';
...
export function NotifProvider({ children }: { children: React.ReactNode }) {
  const [notifs, setNotifs] = useState<Notif[]>([
    { id: '0', icon: 'info', title: 'Welcome to Hirebuddy AI!', body: 'Create a role and upload CVs to get started.', time: new Date(), read: false },
  ]);
    ...
    <aside style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '20px 14px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 10px', marginBottom: '24px' }}>
          ...
          <div>
            <div className="text-gradient" style={{ fontSize: '16px', fontWeight: '800', lineHeight: 1.1, fontFamily: 'var(--font-display)' }}>Hirebuddy</div>
        ...
        <div style={{ paddingTop: '14px', borderTop: '1px solid var(--border-color)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '9px 11px', borderRadius: 'var(--radius)', cursor: 'pointer', transition: 'background 0.15s' }}
